...
const AboutTramboory = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-purple-900 to-indigo-900 z-[100]">
      {/* Sección Hero */}
      <section className="relative pt-8 pb-16 bg-gradient-to-b from-black/70 to-purple-900/70">

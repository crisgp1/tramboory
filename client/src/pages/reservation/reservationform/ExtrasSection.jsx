...
const ExtrasSection = ({ extras, control, setValue }) => {
  ...
  const handleExtraToggle = useCallback((extra) => {
    ...
    if (existingIndex === -1) {
      setValue('extras', [...currentExtras, { id: extra.id, cantidad: 1 }]);
    } else {
  ...
  const handleQuantityChange = useCallback((extraId, newQuantity) => {
    ...
    if (newQuantity < 1) {
      ...
      updatedExtras[existingIndex] = { ...updatedExtras[existingIndex], cantidad: newQuantity };
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-3">
                ...
                {isSelected && renderQuantityControls(extra.id, existingExtra.cantidad)}
              </div>
            </div>
          );
        })}

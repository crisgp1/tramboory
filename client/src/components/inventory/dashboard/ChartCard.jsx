...
const ChartCard = ({ 
  ...
  return (
    <FadeInUp delay={delay} className={`h-full ${className}`}>
      <div className="bg-white p-5 rounded-xl shadow-sm h-full border border-gray-100 relative overflow-hidden">
        {/* Elemento decorativo */}
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-gray-50 to-transparent rounded-bl-full opacity-80"></div>
        ...
        <div className="flex items-center justify-between mb-4 relative z-10">
          ...
          <div className="flex space-x-1">
            ...
            <div className="relative">
              ...
              {showActions && (
                <motion.div 
                  className="absolute right-0 mt-1 bg-white shadow-lg rounded-lg py-1 z-20 min-w-[120px] border border-gray-100"
